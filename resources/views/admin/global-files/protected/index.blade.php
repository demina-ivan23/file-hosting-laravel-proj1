            ...
            <div class="ml-auto" style="margin-left: auto">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="{{route('admin.global-files.protected', ['category' => $category])}}">{{$category}}</a></li>
                  @endforeach
                  <li><a class="dropdown-item" href="{{route('admin.global-files.protected')}}">All</a></li>
                </ul>
              </div>
              </div>
            <div class="ml-auto" style="margin-left: auto">
